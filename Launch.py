'''
The main script that contains all the functions end to end process an image and give the results.
@input: Image of the nameplate visible
@output:Number from nameplate with their respective text.
'''
...
def main(img_path,save_intermediate=False,output_folder=False,showSteps=False):
    print("This path: ", img_path)
    print("Type: ", type(img_path))
